...
$title = $product->title;
$type = 'website';
$url = 'https://www.sediq.net/product/' . $product->id;
$image = "$product->image";
                                        ...
                                        <div class="ec-single-social">
                                            <ul class="mb-0">
                                                ...
                                                <li class="list-inline-item instagram"><a target="_blank"
                                                        href="https://www.instagram.com/?url={{ urlencode(URL::current()) }}"><i
                                                            class="ecicon eci-instagram"></i></a></li>
                                                <li class="list-inline-item youtube-play"><a target="_blank"
                                                        href="https://www.youtube.com/?url={{ urlencode(URL::current()) }}"><i
                                                            class="ecicon eci-youtube-play"></i></a></li>
                                                <li class="list-inline-item behance"><a target="_blank"
                                                        href="https://www.behance.net/?url={{ urlencode(URL::current()) }}"><i
                                                            class="ecicon eci-behance"></i></a></li>
                                                <li class="list-inline-item whatsapp"><a target="_blank"
                                                        href="https://wa.me/?text={{ urlencode(URL::current()) }}"><i
                                                            class="ecicon eci-whatsapp"></i></a></li>
                                                <li class="list-inline-item plus"><a href="javascript:void(0);"
                                                        onclick="navigator.share({url: '{{ urlencode(URL::current()) }}'})"><i
                                                        ...
                                                        @if ($subcategory->products->count())
                                                            <li>
                                                                <div class="ec-sidebar-sub-item"><a
                                                                        ...
                                                                        <span>-{{ $subcategory->products->count() }}</span></a>
                                                                </div>
                                                            </li>
                                                        @endif
                                                    @endforeach
                                ...
                                <div class="ec-pro-option">
                                    <div class="ec-pro-size">
                                        ...
                                        <ul class="ec-opt-size">
                                            @foreach ($product->sizes as $size)
                                                <li class="active"><a href="#" class="ec-opt-sz"
                                                        data-tooltip="{{ $size->name }}">{{ $size->name }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
