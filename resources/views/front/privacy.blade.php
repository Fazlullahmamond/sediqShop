            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        ...
                        <p class="sub-title mb-3">Welcome to the Arezo Boutique marketplace</p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="ec-common-wrapper">
                        <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
                                <h3 class="ec-cms-block-title">Welcome to the Arezo Boutique marketplace</h3>
                                <p class='mb-3'>We at Arezo Boutique are committed to protecting your privacy. This Privacy Policy governs our data collection, processing, and usage practices. By using our website, you consent to the data practices described in this policy.</b></b></p>
                            </div>
                        </div>
                        <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
                        ...
                        <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
                                ...
                                <p class='mb-3'>If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:contact@arezoboutique.com">contact@arezoboutique.com</a>.</b></b></p>
                            </div>
                        </div>
                    </div>
                </div>
