										...
										<table id="responsive-data-table" class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td>
													{{-- @foreach ($subcategories->category as $category) --}}
                                                        <span class="ec-sub-cat-tag">{{ $subcategories->category->name}}</span>
                                                    {{-- @endforeach														 --}}
													</td>
													<td>
														<div class="btn-group">
															<a type="button" href="subcategories/{{ $subcategories->id }}" class="btn btn-outline-success">Edit</a>
															<form action="{{ route('subcategories.destroy', $subcategories->id) }}" method="POST" class="btn btn-outline-danger">
																@csrf
																@method('DELETE')
