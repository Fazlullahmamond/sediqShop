            ...
            <div id="sidebar" class="sidebar ec-sidebar-footer">
                ...
                <div class="ec-brand">
                    <a href="index.html" title="Ekka">
                        <img class="ec-brand-icon" src="{{ asset('back/assets/img/logo/ec-site-logo.png') }}" alt="" />
                                                ...
                                                <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                        ...
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('back/assets/img/user/u2.jpg') }}" alt="Image">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('back/assets/img/user/u1.jpg') }}" alt="Image">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('back/assets/img/user/u5.jpg') }}" alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                                <div class="message-contents">
                                                ...
                                                <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('back/assets/img/user/u6.jpg') }}" alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                                <div class="message-contents">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('back/assets/img/user/u7.jpg') }}" alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                                <div class="message-contents">
